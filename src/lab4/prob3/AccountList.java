...
public class AccountList {
	...
	public static void main(String[] args) {
		/*
		 * MyStringList l = new MyStringList(); l.add("Bob"); l.add("Steve");
		 * l.add("Susan"); l.add("Mark"); l.add("Dave");
		 * System.out.println("The list of size "+l.size()+" is "+l); l.remove("Mark");
		 * l.remove("Bob"); System.out.println("The list of size "+l.size()+" is "+l);
		 * l.insert("Richard",3); System.out.println("The list of size "+l.size()
